...
export class Background {
    ...
    constructor(cam) {
        ...
        this.createlayer0()
        this.camera = cam
        this.bgcolor = "rgba(225, 241, 225, .3)"
        this.color = "#000"//`rgba(${this.camera.game.gameDisplayer.r}, ${this.camera.game.gameDisplayer.g}, ${this.camera.game.gameDisplayer.b}, .3)`
    }
...
// ctx.fillRect((x/1) + 0, (y/2) + 0, 0, 0);
    ...
    Draw() {
        this.color = `rgba(${this.camera.game.gameDisplayer.r}, ${this.camera.game.gameDisplayer.g}, ${this.camera.game.gameDisplayer.b}, 1)`
        for (let i = 0; i < this.layer6.length; i++) {
            this.layer6[i].draw(this.camera.x / 7, this.camera.y / 7, this.color)
        }
        ctx.fillStyle = this.bgcolor;
        ctx.rect(0, 0, 100000, 10000) 
        ctx.fill()
        for (let i = 0; i < this.layer5.length; i++) {
            this.layer5[i].draw(this.camera.x / 6, this.camera.y / 6, this.color)
        }
        ctx.fillStyle = this.bgcolor;
        ctx.rect(0, 0, 100000, 10000) 
        ctx.fill()
        for (let i = 0; i < this.layer4.length; i++) {
            this.layer4[i].draw(this.camera.x / 5, this.camera.y / 5, this.color)
        }
        ctx.fillStyle = this.bgcolor;
        ctx.rect(0, 0, 100000, 10000) 
        ctx.fill()
        for (let i = 0; i < this.layer3.length; i++) {
            this.layer3[i].draw(this.camera.x / 4, this.camera.y / 4, this.color)
        }
        ctx.fillStyle = this.bgcolor;
        ctx.rect(0, 0, 100000, 10000) 
        ctx.fill()
        for (let i = 0; i < this.layer2.length; i++) {
            this.layer2[i].draw(this.camera.x / 3, this.camera.y / 3, this.color)
        }
        ctx.fillStyle = this.bgcolor;
        ctx.rect(0, 0, 100000, 10000) 
        ctx.fill()
        for (let i = 0; i < this.layer1.length; i++) {
            this.layer1[i].draw(this.camera.x / 2, this.camera.y / 2, this.color)  
        }
        ctx.fillStyle = this.bgcolor;
        ctx.rect(0, 0, 100000, 10000) 
        ctx.fill()
